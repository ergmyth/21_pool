...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/02/03 18:29:32 by eleonard          #+#    #+#             */
/*   Updated: 2019/02/16 15:53:44 by eleonard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw(int width, int height, int line)
{
	...
	while ((counter = 1) && height >= line && width >= 1)
	{
		...
		if ((line == 1) && (border_symbol = 'A'))
			middle_symbol = 'B';
		else if ((line == height) && (border_symbol = 'C'))
			middle_symbol = 'B';
		...
		if (width >= 2 && line == 1 && (border_symbol = 'C'))
			ft_putchar(border_symbol);
		else if (width >= 2 && line == height && (border_symbol = 'A'))
			ft_putchar(border_symbol);
		else if (width >= 2)
			ft_putchar(border_symbol);
		ft_putchar('\n');
